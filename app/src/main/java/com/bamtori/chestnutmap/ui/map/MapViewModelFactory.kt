 ...
 */
class MapViewModelFactory(private val mapRepository: MapRepository, private val markerRepository: MarkerRepository) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(MapViewModel::class.java)) {
            @Suppress("UNCHECKED_CAST")
            return MapViewModel(mapRepository, markerRepository) as T
        }
